(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["shopify-app-shopify-app-module"],{
...
/***/ "./src/app/shopify-app/components/main/main-material.html":
/*!****************************************************************!*\
  !*** ./src/app/shopify-app/components/main/main-material.html ***!
  \****************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3Nob3BpZnktYXBwL2NvbXBvbmVudHMvbWFpbi9tYWluLW1hdGVyaWFsLnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/shopify-app/components/main/main.component.ts":
/*!***************************************************************!*\
  !*** ./src/app/shopify-app/components/main/main.component.ts ***!
  \***************************************************************/
...
/* harmony import */ var ngx_tour_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-tour-ng-bootstrap */ "./node_modules/ngx-tour-ng-bootstrap/fesm5/ngx-tour-ng-bootstrap.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! rxjs/operators */ "./node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _core_menu_menu_items_menu_items__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../core/menu/menu-items/menu-items */ "./src/app/core/menu/menu-items/menu-items.ts");
/* harmony import */ var _core_page_title_page_title_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../../core/page-title/page-title.service */ "./src/app/core/page-title/page-title.service.ts");
/* harmony import */ var app_confirm_dialog_services_confirm_dialog_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! app/confirm-dialog/services/confirm-dialog.service */ "./src/app/confirm-dialog/services/confirm-dialog.service.ts");
/* harmony import */ var app_authentication_services_auth_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! app/authentication/services/auth.service */ "./src/app/authentication/services/auth.service.ts");
...
var MainComponent = /** @class */ (function () {
    function MainComponent(tourService, authService, menuItems, confirmDialogService, pageTitleService, translate, router, media) {
    ...
    MainComponent.prototype.confirmAccountReady = function () {
        var _this = this;
        if (!this.authService.currentUser.profile) {
            var confirm_1 = 'Usted no a completado su Perfil';
            var message = 'Para poder usar nuestra Aplicación y servicios de Correos de Chile debe completar su cuenta, por favor no salte este paso. Gracias...!';
            this.confirmDialogService.confirm(confirm_1, message)
                .then(function (confirmed) {
                if (confirmed) {
                    _this.router.navigate(['/carrier/user/profile']);
                }
            })
                .catch(function () {
                _this.router.navigate(['/carrier/user/profile']);
    ...
    MainComponent.prototype.getMenuItems = function () {
        this.menuItemsList = this.menuItems.getAll();
    };
    MainComponent.prototype.initialsConfigurations = function () {
        var _this = this;
        this.innerWidth = window.innerWidth;
        this.pageTitleService.title.subscribe(function (val) {
            _this.header = val;
        });
        this._router = this.router.events.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["filter"])(function (event) { return event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"]; })).subscribe(function (event) {
            _this.url = event.url;
        });
        if (this.url !== '/session/login' && this.url !== '/session/register'
            ...
            if (window.matchMedia("(min-width: 1280px)").matches) {
                var ps = new perfect_scrollbar__WEBPACK_IMPORTED_MODULE_4__["default"](elemSidebar, {
                    wheelSpeed: 2,
            ...
            if (window.matchMedia("(min-width: 1280px)").matches) {
                var pse = new perfect_scrollbar__WEBPACK_IMPORTED_MODULE_4__["default"](elemChatbar);
            }
        ...
        this._routerEventsSubscription = this.router.events.subscribe(function (event) {
            if (event instanceof _angular_router__WEBPACK_IMPORTED_MODULE_2__["NavigationEnd"] && _this.isMobile) {
                _this.sidenav.close();
            }
        });
    ...
    MainComponent.prototype.goMyProfile = function () {
    ...
    MainComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./main-material.html */ "./src/app/shopify-app/components/main/main-material.html"),
            encapsulation: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewEncapsulation"].None,
            styles: [__webpack_require__(/*! ./main-material.scss */ "./src/app/shopify-app/components/main/main-material.scss")]
        }),
        __metadata("design:paramtypes", [ngx_tour_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["TourService"],
            app_authentication_services_auth_service__WEBPACK_IMPORTED_MODULE_10__["AuthService"],
            _core_menu_menu_items_menu_items__WEBPACK_IMPORTED_MODULE_7__["MenuItems"],
            app_confirm_dialog_services_confirm_dialog_service__WEBPACK_IMPORTED_MODULE_9__["ConfirmDialogService"],
            _core_page_title_page_title_service__WEBPACK_IMPORTED_MODULE_8__["PageTitleService"],
...
/***/ "./src/app/shopify-app/shopify-app-routing.module.ts":
/*!***********************************************************!*\
  !*** ./src/app/shopify-app/shopify-app-routing.module.ts ***!
  \***********************************************************/
/*! exports provided: ShopifyAppRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShopifyAppRoutingModule", function() { return ShopifyAppRoutingModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _components_main_main_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/main/main.component */ "./src/app/shopify-app/components/main/main.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ShopifyAppRoutingModule = /** @class */ (function () {
    function ShopifyAppRoutingModule() {
    }
    ShopifyAppRoutingModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]]
        })
    ], ShopifyAppRoutingModule);
    return ShopifyAppRoutingModule;
}());
...
/*!***************************************************!*\
  !*** ./src/app/shopify-app/shopify-app.module.ts ***!
  \***************************************************/
/*! exports provided: ShopifyAppModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ShopifyAppModule", function() { return ShopifyAppModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common */ "./node_modules/@angular/common/fesm5/common.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _components_main_main_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/main/main.component */ "./src/app/shopify-app/components/main/main.component.ts");
...
/* harmony import */ var app_confirm_dialog_confirm_dialog_module__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! app/confirm-dialog/confirm-dialog.module */ "./src/app/confirm-dialog/confirm-dialog.module.ts");
/* harmony import */ var _shopify_app_routing_module__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shopify-app-routing.module */ "./src/app/shopify-app/shopify-app-routing.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ShopifyAppModule = /** @class */ (function () {
    function ShopifyAppModule() {
    }
    ShopifyAppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _shopify_app_routing_module__WEBPACK_IMPORTED_MODULE_9__["ShopifyAppRoutingModule"],
                ngx_perfect_scrollbar__WEBPACK_IMPORTED_MODULE_5__["PerfectScrollbarModule"],
                ngx_tour_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["TourNgBootstrapModule"].forRoot(),
                _ngx_translate_core__WEBPACK_IMPORTED_MODULE_6__["TranslateModule"],
                app_confirm_dialog_confirm_dialog_module__WEBPACK_IMPORTED_MODULE_8__["ConfirmDialogModule"],
            ],
            declarations: [
...
//# sourceMappingURL=shopify-app-shopify-app-module.js.map