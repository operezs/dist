...
var OrdersTableComponent = /** @class */ (function () {
    ...
    OrdersTableComponent.prototype.generateAdmition = function (index) {
        // const id = this.companies[index].id;
