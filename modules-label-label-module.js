...
/* harmony import */ var app_routing_services_id_resolve_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! app/routing/services/id-resolve.service */ "./src/app/routing/services/id-resolve.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        resolve: {
            ...
            admitedId: app_routing_services_id_resolve_service__WEBPACK_IMPORTED_MODULE_4__["IdResolveService"],
        },
    },
];
